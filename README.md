...
An adapter to use [ELF4J native](https://github.com/elf4j/elf4j-impl-core) implementation as the logging engine for the Java 9 platform logging (System.Logger) API
