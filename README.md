...
An adapter to use a [native ELF4J](https://github.com/elf4j/elf4j-impl-core) implementation as the runtime log engine
for the Java 9 Platform Logging (System.Logger) API
